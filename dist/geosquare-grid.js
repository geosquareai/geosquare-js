(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@turf/turf')) :
    typeof define === 'function' && define.amd ? define(['exports', '@turf/turf'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.GeosquareGrid = {}, global.turf));
})(this, (function (exports, turf) { 'use strict';
    ...
    class GeosquareGrid {
      constructor() {
        ...
        this.CODE_ALPHABET = [["2", "3", "4", "5", "6"], ["7", "8", "9", "C", "E"], ["F", "G", "H", "J", "L"], ["M", "N", "P", "Q", "R"], ["T", "V", "W", "X", "Y"]];
      ...
      lonlatToGID(longitude, latitude, level) {
        ...
        for (let idx = 0; idx < level; idx++) {
          const position_x = Math.floor((longitude - lon_ranged[0]) / (lon_ranged[1] - lon_ranged[0]) * this.d[idx]);
          const position_y = Math.floor((latitude - lat_ranged[0]) / (lat_ranged[1] - lat_ranged[0]) * this.d[idx]);
      ...
      gidToGeometry(gid) {
        ...
        return turf__namespace.polygon([[[bounds[0], bounds[1]], [bounds[0], bounds[3]], [bounds[2], bounds[3]], [bounds[2], bounds[1]], [bounds[0], bounds[1]]]]);
      }
       ...
       */
      _areaRatio(a, b) {
        const aArea = turf__namespace.area(a);
        const intersection = turf__namespace.intersect(a, b);
        if (!intersection) return 0;
        return parseFloat((turf__namespace.area(intersection) / aArea).toFixed(20));
      }
       ...
       */
      _getContainedKeys(geometry, initialKey, resolution) {
        let fullcover = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
        if (initialKey !== "2") {
          geometry = turf__namespace.intersect(geometry, this.gidToGeometry(initialKey));
          if (!geometry) return [];
        }
        const containedKeys = [];
       ...
       */
      parrentToAllchildren(key, size) {
        let geometry = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
       ...
       */
      polyfill(polygon, size) {
        let start = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "2";
        let fullcover = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
        let resolution;
     ...
     * @returns {Array<string>} List of grid identifiers that intersect with the polygon
     */
    function polyfill(polygon, size) {
      let start = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "2";
      let fullcover = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
      const grid = new GeosquareGrid();
    ...
    exports.GIDToLonlat = GIDToLonlat;
    exports["default"] = GeosquareGrid;
    exports.fromLonLat = fromLonLat;
    exports.getBounds = getBounds;
    exports.getGeometry = getGeometry;
    exports.lonlatToGID = lonlatToGID;
    exports.polyfill = polyfill;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=geosquare-grid.js.map
